...
(function(){
 ...
 const links=academy?[
 ['index.html','Tableau de bord','grid'],['agents.html','Tous les agents','users'],['effectifs.html','Suivi pédagogique','chart'],['evaluations.html','Formations','book'],['recrutements.html','Recrutements','inbox'],['activite.html','Historique','clock'],['configuration.html','Configuration','list']
