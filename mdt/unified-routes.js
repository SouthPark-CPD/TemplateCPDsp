...
(function(root){
 const routes={procedures:'/mdt/procedures.html',radio:'/mdt/code.html',reglement:'/mdt/reglement.html',tenues:'/mdt/tenues-vehicules.html',organigramme:'/mdt/organigramme.html',rapide:'/mdt/acces-rapide.html',liaison:'/mdt/liaison.html',pa:'/academy-admin/index.html',suivi:'/academy-admin/effectifs.html',formations:'/academy-admin/evaluations.html',recrutements:'/academy-admin/recrutements.html',activite:'/academy-admin/activite.html',dossier:'/academy-admin/dossier.html',sessions:'/academy-admin/sessions.html'};
