...
(function(root){
 const routes={procedures:'/mdt/procedures.html',radio:'/mdt/code.html',reglement:'/mdt/reglement.html',tenues:'/mdt/tenues-vehicules.html',organigramme:'/mdt/organigramme.html',rapide:'/mdt/acces-rapide.html',pa:'/academy-admin/index.html',agents:'/academy-admin/agents.html',suivi:'/academy-admin/effectifs.html',formations:'/academy-admin/evaluations.html',recrutements:'/academy-admin/recrutements.html',activite:'/academy-admin/activite.html',dossier:'/academy-admin/dossier.html',sessions:'/academy-admin/sessions.html'};
 ...
 function fromShell(value,origin){
  const u=new URL(value,origin),view=Object.hasOwn(routes,u.searchParams.get('view'))?u.searchParams.get('view'):'procedures';
