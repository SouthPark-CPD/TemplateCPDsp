...
(function(root){
 const routes={procedures:'/mdt/procedures.html',radio:'/mdt/code.html',reglement:'/mdt/reglement.html',tenues:'/mdt/tenues-vehicules.html',organigramme:'/mdt/organigramme.html',rapide:'/mdt/acces-rapide.html',liaison:'/mdt/liaison.html',doj:'/mdt/communication-doj.html', 'liaison-gouv':'/mdt/liaison-gouvernement.html',avocat:'/mdt/liaison-avocat.html',channel:'/mdt/channel.html',pa:'/academy-admin/index.html',suivi:'/academy-admin/effectifs.html',formations:'/academy-admin/evaluations.html',recrutements:'/academy-admin/recrutements.html',activite:'/academy-admin/activite.html',configuration:'/academy-admin/configuration.html',dossier:'/academy-admin/dossier.html',sessions:'/academy-admin/sessions.html'};
 ...
 function resolve(value,origin){
  ...
  let view=Object.keys(routes).find(k=>routes[k]===u.pathname);if(!view)return null;
